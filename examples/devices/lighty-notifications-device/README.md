...
**Run device**
* extract binary distribution `lighty-notifications-device-13.0.2-bin.zip`
from target directory
* run jar file from zip with default parameter
```
java -jar lighty-notifications-device-13.0.2.jar
```
To run device on specific port, add port number as an argument
* run device on specific port `12345` (any available port)
```
java -jar lighty-notifications-device-13.0.2.jar 12345
```
